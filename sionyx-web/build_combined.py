content = open(r'.\src\components\settings\AuthDesignSettings.jsx', encoding='utf-8').read()

# קרא את הקוד של KioskBackgroundSettings
bg_content = open(r'.\src\components\settings\KioskBackgroundSettings.jsx', encoding='utf-8').read()

combined = """import { useState, useEffect } from "react";
