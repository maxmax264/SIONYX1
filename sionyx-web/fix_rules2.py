...
old = '".write": "auth != null && ((root.child(\'organizations\').child($orgId).child(\'users\').child(auth.uid).child(\'isAdmin\').val() === true || root.child(\'organizations\').child($orgId).child(\'users\').child(auth.uid).child(\'role\').val() === \'admin\') || (!data.exists() && root.child(\'supervisors\').child(auth.uid).child(\'organizations\').child($orgId).exists()) || data.child(\'toUserId\').val() == auth.uid)"'

new = '".write": "auth != null && ((root.child(\'organizations\').child($orgId).child(\'users\').child(auth.uid).child(\'isAdmin\').val() === true || root.child(\'organizations\').child($orgId).child(\'users\').child(auth.uid).child(\'role\').val() === \'admin\' || root.child(\'supervisors\').child(auth.uid).child(\'organizations\').child($orgId).exists()) || data.child(\'toUserId\').val() == auth.uid)"'
