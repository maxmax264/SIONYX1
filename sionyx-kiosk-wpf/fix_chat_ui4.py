...
old = '''<ContentControl Margin="0,0,0,14">
...
new = '''<Grid Margin="0,0,0,14">
                                                ...
                                                <!-- הודעת מנהל/פיקוח - משמאל, אפור -->
                                                <Border Grid.Column="0" CornerRadius="12" Padding="14,10"
                                                        MaxWidth="320" HorizontalAlignment="Left"
                                                        Background="#F1F5F9" Margin="0,0,4,0">
                                                    <Border.Style>
                                                ...
                                                <!-- הודעת משתמש - מימין, כחול -->
                                                <Border Grid.Column="1" CornerRadius="12" Padding="14,10"
                                                        MaxWidth="320" HorizontalAlignment="Right"
                                                        Margin="4,0,0,0">
                                                    <Border.Style>
                                                        <Style TargetType="Border">
                                                            <Setter Property="Visibility" Value="Collapsed"/>
