...
new = '''                <div id="saveCardCheckBox" style="display:none; margin-bottom:14px; padding:12px 16px; background:#F8FAFC; border:1.5px solid #E2E8F0; border-radius:10px; direction:rtl;">
                ...
                <div id="saveCardExpiryRow" style="display:none; flex-direction:column; gap:6px; margin-bottom:14px;">
                    <label class="input-label" for="saveCardExpiryInput" style="margin-bottom:0;">תוקף</label>
                    <input type="text" id="saveCardExpiryInput" class="input-field" style="margin-bottom:0; max-width:140px; direction:ltr; text-align:center; letter-spacing:2px; font-family:'Courier New',monospace;"
                        maxlength="5" placeholder="MM/YY" inputmode="numeric" autocomplete="off">
                </div>'''
