...
public class AuditFixTests : IDisposable
{
    ...
    [Fact]
    public void HelpViewModel_FeedbackText_CanBeSetAndRetrieved()
    {
        ...
        vm.FeedbackText = "Test feedback";
        vm.FeedbackText.Should().Be("Test feedback");
    }

    [Fact]
    public void HelpViewModel_FeedbackStatus_NotifiesPropertyChanged()
    {
        var orgService = new OrganizationMetadataService(null!);
        var opHours = new OperatingHoursService(null!);
        var vm = new HelpViewModel(orgService, opHours);
        ...
        vm.FeedbackStatus = "Sent!";

        changed.Should().Contain("FeedbackStatus");
    }

    [Fact]
    public void HelpViewModel_SendFeedback_EmptyText_SetsWarning()
    {
        var orgService = new OrganizationMetadataService(null!);
        var opHours = new OperatingHoursService(null!);
        var vm = new HelpViewModel(orgService, opHours);
    ...
    public void SessionCoordinator_SubscribeUnsubscribe_Cycle()
    {
        ...
        var coordinator = new SessionCoordinator(session, printMonitor, auth);
