...
public class AuditFixTests : IDisposable
{
    ...
    public void SessionCoordinator_SubscribeUnsubscribe_Cycle()
    {
        ...
        var coordinator = new SessionCoordinator(session, printMonitor, auth, new PrintHistoryService(), new IdleTimeoutService(), new OrganizationMetadataService(_firebase));
