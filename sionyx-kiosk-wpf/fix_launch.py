...
old = 'Id="CA_LaunchKiosk"        BinaryRef="CustomActionsDll" DllEntry="LaunchKiosk"        Execute="immediate" Return="ignore" />'

new = 'Id="CA_LaunchKiosk" BinaryRef="CustomActionsDll" DllEntry="LaunchKiosk" Execute="immediate" Return="ignore" />'
