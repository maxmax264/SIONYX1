...
old = '''onChange={(_, hex) => handleDesignChange("overlayColor1", hex)}'''
new = '''onChange={(color) => handleDesignChange("overlayColor1", color.toHexString())}'''
...
old2 = '''onChange={(_, hex) => handleDesignChange("overlayColor2", hex)}'''
new2 = '''onChange={(color) => handleDesignChange("overlayColor2", color.toHexString())}'''
